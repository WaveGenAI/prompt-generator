...
class Phi3Model:
    ...
    def __init__(self):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(
            "microsoft/Phi-3-mini-4k-instruct", torch_dtype=torch.float16, device_map="auto", trust_remote_code=True)
    ...
    def generate_response(self, prompts: List[Prompt] | Prompt) -> List[Prompt]:
        ...
        output_sequences = self.model.generate(**inputs, max_new_tokens=32)
